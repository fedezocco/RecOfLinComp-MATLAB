...
AE_1 = trainAutoencoder(X', v_NumOfNeuronsPerEncoder(1,1)); %,'L2WeightRegularization',0.01, 'SparsityRegularization',0, 'SparsityProportion',1);
...
if NumOfEncoders > 1
    for i = 2:NumOfEncoders
        AE_i = trainAutoencoder(Z_tilde', v_NumOfNeuronsPerEncoder(1,i)); %,'L2WeightRegularization',0.01, 'SparsityRegularization',0, 'SparsityProportion',1);  
